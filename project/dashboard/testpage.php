...
<body>
    <?php 
        include('../../connection_database/database.php');
    ?>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <section class="Agents px-4">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Freelancer</button>
